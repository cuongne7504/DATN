  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <div class="login-brand">
        ...
        <div>
          <h1>Đăng nhập</h1>
          <p>Chào mừng bạn đến với SportPro</p>
        </div>
      </div>
      ...
      <div class="text-center mt-4">
        ...
        <router-link to="/register" class="fw-bold ms-1">Đăng ký ngay</router-link>
      </div>
      <div class="text-center mt-3">
        <router-link to="/" class="back-home"><i class="bi bi-arrow-left me-1"></i> Về trang chủ</router-link>
      </div>
    </div>
  </div>
</template>
...
.login-form .mb-3:nth-child(1) { animation-delay: 0.08s; }
.login-form .mb-4 { animation-delay: 0.16s; }
.login-btn { animation: rise 0.5s cubic-bezier(0.22, 1, 0.36, 1) 0.24s both; }
